...
insert into carrera
values 	(null, 'Full Stack Developer'),
		(null, 'Data Science');

insert into instructor
values 	(null, 25456879,'Antonio','Barrios','1981-7-9','2019-11-8');

insert into instructor
values	(null, 28456321,'Lucia','Fernandez','1992-5-25','2019-11-8'),
		(null, 27198354,'Leo','Paris','1985-6-20','2021-8-15'),
		(null, 36987520,'Agustín','Casagne','1988-8-17','2021-8-15'),
		(null, 33456215,'Franco','Caseros','1995-5-1','2021-8-15'),
		(null, 30521369,'Dario','Ramirez','1989-7-20','2021-12-1'),
		(null, 28856789,'Agustina','Medina','1991-3-8','2021-12-1'),
		(null, 33128987,'Jorge','Perez','1988-2-19','2021-12-1');
...
value 	('FT-1235',1,1,'2020-2-1','2020-6-30');
...
select distinct instructor.IDinstructor, instructor.nombre, instructor.apellido, carrera.nombre 
from instructor
inner join cohorte 
...
select alumno.IDalumno, alumno.nombre, alumno.apellido
from alumno 
inner join cohorte 
...
select alumno.IDalumno, alumno.nombre, alumno.apellido, cohorte.codigo
from alumno
inner join cohorte 
on alumno.IDcohorte = cohorte.IDcohorte
where cohorte.IDcohorte = 1235 and alumno.fechaIngreso like '2019%';
...
select alumno.IDalumno, alumno.nombre, alumno.apellido, fechaNacimiento, carrera.nombre
from alumno
inner join cohorte
on alumno.IDcohorte = cohorte.IDcohorte
inner join carrera
on cohorte.IDcarrera = carrera.IDCarrera
order by alumno.IDalumno asc;

/*
Coneste la siguientes interrogantes:
  a. ¿Que campos permiten que se puedan acceder al nombre de la carrera? R/nombre
  b. ¿Que tipo de ralación existe entre el nombre la tabla cohortes y alumnos? R/1-n
...
select carrera.nombre, count(alumno.IDalumno)
from alumno
inner join cohorte 
on alumno.Idcohorte = cohorte.IDcohorte
inner join carrera
